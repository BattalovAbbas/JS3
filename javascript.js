...
function Change(){
    if(document.getElementById('inputText').value !=""){
        var result = confirm("Вы точно хотите изменить '"+document.getElementById(activeIndex).innerText+
...
function Delete(){
    var result = confirm("Вы точно хотите удалить '"+document.getElementById(activeIndex).innerText+"'?");
    if(result) {
        var elem = document.getElementById(activeIndex);
